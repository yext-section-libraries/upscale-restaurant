...
type UpscaleRestaurantOnlineOrderBannerProps = {
  data: {
...
const UpscaleRestaurantOnlineOrderBannerFields: YextFields<UpscaleRestaurantOnlineOrderBannerProps> = {
  data: {
    label: "Banner Text",
    type: "object",
    objectFields: {
...
const UpscaleRestaurantOnlineOrderBannerComponent: PuckComponent<UpscaleRestaurantOnlineOrderBannerProps> = ({
  data,
  styles,
  section,
  puck,
 ...
 */
export const UpscaleRestaurantOnlineOrderBanner: YextComponentConfig<UpscaleRestaurantOnlineOrderBannerProps> = {
  label: "Banner",
  fields: toPuckFields(UpscaleRestaurantOnlineOrderBannerFields),
  defaultProps: {
    data: {
      text: {
        field: "",
  ...
  render: (props) => (
    ...
    >
      <UpscaleRestaurantOnlineOrderBannerComponent {...props} />
    </VisibilityWrapper>
  ),
};

export const config: SectionConfig = {
  id: "UpscaleRestaurantOnlineOrderBanner",
  displayName: "Banner",
  description: "Banner",
  pageSetTypes: ["ENTITY"],
};
