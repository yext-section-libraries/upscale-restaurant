...
type OfferingsMenuItemProps = {
  ...
  unavailable: YextEntityField<boolean>;
};
  ...
  defaultValues: [
    {
      ...
      unavailable: makeBooleanField(false),
    },
    {
      label: {
        field: "",
    ...
    },
    {
      ...
      unavailable: makeBooleanField(true),
    },
    {
      label: {
        field: "",
...
const makeListItemColor = (
  sectionBackgroundColor: ThemeColor,
  streamDocument: StreamDocument,
): { text: string; unavailable: string } => {
...
const OfferingsSection: PuckComponent<OfferingsSectionProps> = (props) => {
  ...
  const listItemColors = makeListItemColor(
    props.section.backgroundColor,
    streamDocument,
  );
  const pageStyle: OfferingsStyle = {
    "--fb-text": listItemColors.text,
    "--fb-list-bullet": listItemColors.text,
    "--fb-list-unavailable": listItemColors.unavailable,
  };
...
export const UpscaleRestaurantOnlineOrderOfferingsSection: YextComponentConfig<OfferingsSectionProps> =
  {
...
export const config: SectionConfig = {
  id: "UpscaleRestaurantOnlineOrderOfferingsSection",
