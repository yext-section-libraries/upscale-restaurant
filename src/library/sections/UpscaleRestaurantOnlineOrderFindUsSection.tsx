...
const FindUsSection: PuckComponent<FindUsSectionProps> = (props) => {
  ...
  const shouldHideSection = !isEditing && !enabled && !hasNearbyLocations;
  ...
  const shouldShowMap = isEditing || enabled;
...
export const UpscaleRestaurantOnlineOrderFindUsSection: YextComponentConfig<FindUsSectionProps> =
  {
...
export const config: SectionConfig = {
  id: "UpscaleRestaurantOnlineOrderFindUsSection",
