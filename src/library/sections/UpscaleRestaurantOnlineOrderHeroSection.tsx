...
const defaultProps: HeroSectionProps = {
  ...
  hero: {
    ...
    heading: makeText("Order Online from [[name]] - [[address.city]]"),
    description: makeRtf(
    ...
    ctas: [
      { cta: makeCta("Order for Pickup", "#", "primary") },
      { cta: makeCta("Order for Delivery", "#", "secondary") },
...
const HeroSection: PuckComponent<HeroSectionProps> = (props) => {
  ...
  const image = resolvedImage ?? props.hero.image.image.constantValue;
  const hasImage = hasImageSource(image);
  const cardForegroundColor = getThemeColorCssValue(
    getDefaultForegroundColor(props.section.cardBackgroundColor, streamDocument),
  );
  ...
  const headingStyle: React.CSSProperties = {
    ...
    color: getThemeColorCssValue(props.hero.heading.fontColor) ?? cardForegroundColor,
  };
  const descriptionStyles = {
    ...props.hero.description.styles,
    color: getThemeColorCssValue(props.hero.description.fontColor) ?? cardForegroundColor,
  };
  ...
  const pageStyle = {
    "--fb-header-bg": getThemeColorCssValue(props.section.backgroundColor),
    "--fb-header-text":
      getThemeColorCssValue(
        getDefaultForegroundColor(props.section.backgroundColor, streamDocument),
      ) ?? "currentColor",
    "--fb-hero-card-bg": getThemeColorCssValue(props.section.cardBackgroundColor),
    "--fb-hero-card-text": cardForegroundColor ?? "currentColor",
    "--fb-text": cardForegroundColor ?? "currentColor",
    "--fb-muted": cardForegroundColor ?? "currentColor",
    "--fb-primary": "var(--colors-palette-primary)",
    "--fb-stars": "var(--colors-palette-primary)",
  } as React.CSSProperties;
  const heroCardStyle: React.CSSProperties = hasImage
    ? {}
    : {
        position: "relative",
        left: "auto",
    ...
    >
      ...
      >
        ...
        <header className="fb-site-header">
          <section className={hasImage ? "fb-hero" : "fb-hero fb-hero-no-image"}>
            {hasImage ? (
...
export const UpscaleRestaurantOnlineOrderHeroSection: YextComponentConfig<HeroSectionProps> =
  {
    label: "Hero Section",
    fields: heroFields,
    defaultProps,
...
export const config: SectionConfig = {
  id: "UpscaleRestaurantOnlineOrderHeroSection",
