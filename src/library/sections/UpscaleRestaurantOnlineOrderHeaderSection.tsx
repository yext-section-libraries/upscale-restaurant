...
type UpscaleRestaurantOnlineOrderHeaderSectionProps = {
...
const UpscaleRestaurantOnlineOrderHeaderSectionFields: YextFields<UpscaleRestaurantOnlineOrderHeaderSectionProps> = {
  variant: {
    label: "Variant",
    type: "select",
    options: [
...
const UpscaleRestaurantOnlineOrderHeaderSectionComponent: PuckComponent<UpscaleRestaurantOnlineOrderHeaderSectionProps> = (props) => {
  ...
  const renderUtilityIcon = ({
    ...
    const resolvedIconImage = iconImage;
    const iconHeight = 32;
...
export const UpscaleRestaurantOnlineOrderHeaderSection: YextComponentConfig<UpscaleRestaurantOnlineOrderHeaderSectionProps> = {
  label: "Header",
  fields: UpscaleRestaurantOnlineOrderHeaderSectionFields,
  defaultProps: {
  ...
  render: (props) => (
    <AnalyticsScopeProvider
      name={`UpscaleRestaurantOnlineOrderHeaderSection${getAnalyticsScopeHash(props.id)}`}
    >
      <UpscaleRestaurantOnlineOrderHeaderSectionComponent {...props} />
    </AnalyticsScopeProvider>
  ),
};

export const config: SectionConfig = {
  id: "UpscaleRestaurantOnlineOrderHeaderSection",
  displayName: "Header",
  description: "Header",
  pageSetTypes: ["ENTITY"],
};
